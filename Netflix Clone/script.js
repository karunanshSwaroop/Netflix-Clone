...
const api = "api_key=510e51229901d50c8e343c05e1b8e2c6";
...
fetch(request.fetchNetflixOriginals)
  ...
  .then((data) =>{
    ...
    //every referesh the movie will be change.
  ...
  fetch(request.fetchNetflixOriginals)
    ...
    .then((data) => {
      ...
      title.innerText =  "NETFLLIX ORIGINALS";
